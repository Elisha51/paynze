  ...
  return (
    <Tabs defaultValue="overview">
        <TabsList>
            ...
            {product.inventoryTracking !== 'Don\'t Track' && <TabsTrigger value="inventory">Inventory</TabsTrigger>}
        </TabsList>
        ...
        <TabsContent value="inventory">
             <Card className="mt-4">
                <CardHeader>
                    ...
                    <CardDescription>
                        {product.inventoryTracking === 'Track with Serial Numbers' 
                            ? 'Track each individual item by its serial number and status.'
                            : 'Overview of stock quantities for each variant.'
                        }
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {product.inventoryTracking === 'Track with Serial Numbers' ? (
                        <Table>
                         ...
                         <p className="text-sm text-muted-foreground">
                           Detailed inventory tracking is only available for products tracked with serial numbers.
                         </p>
                    )}
                </CardContent>
            </Card>
