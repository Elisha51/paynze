...
import { List, Target, Award, MapPin, Type, Hash, ToggleRight, Calendar, Edit, Truck } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Your assignments, schedule, and performance metrics.</p>
                </div>
            </div>
           ...
           <div className="space-y-6">
                ...
                {showAssignedOrders && (
                        ...
                        <CardContent>
                            <DataTable columns={orderColumns} data={assignedOrders} emptyState={{icon: Truck, title: "No Orders Assigned", description: "You currently have no orders assigned to you."}} />
                        </CardContent>
                    </Card>
                )}
