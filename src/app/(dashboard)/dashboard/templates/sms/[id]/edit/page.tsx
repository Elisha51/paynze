...
export default function EditSmsTemplatePage() {
    ...
    if (!template) {
         return (
            <DashboardPageLayout title="Error" backHref="/dashboard/templates?tab=sms-templates">
    ...
    return (
        <DashboardPageLayout title={`Edit "${template?.name}" Template`} backHref="/dashboard/templates?tab=sms-templates">
             <SmsTemplateForm initialTemplate={template} />
        </DashboardPageLayout>
    );
}
