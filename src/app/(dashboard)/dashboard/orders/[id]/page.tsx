...
import type { Order, OnboardingFormData, Staff, DeliveryNote } from '@/lib/types';
import {
  Card,
  CardContent,
  CardDescription,
...
import { RevertStatusDialog } from '@/components/dashboard/revert-status-dialog';
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        {canEdit && order.status === 'Awaiting Payment' && order.payment.status === 'pending' && (
                         ...
                         {canEdit && order.status === 'Paid' && order.fulfillmentMethod === 'Delivery' && (
                           <FulfillOrderDialog order={order} action="ship" onUpdate={handleOrderUpdate}>
