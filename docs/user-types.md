...
-   **Onboarding:** This is the user who goes through the initial sign-up and setup process in `/get-started`.
...
-   **Onboarding:** They sign up through a public-facing form at `/store/affiliate-signup` and must be approved by a Merchant in the dashboard.
-   **Access:** Affiliates do **not** have access to the main business dashboard. They have their own separate, simplified dashboard at `/affiliate/dashboard` where they can view their unique referral link, track clicks, see referred sales, and monitor their commission earnings.
...
-   **Onboarding:** They can browse the store as a guest, or they can create an account via `/store/signup`.
-   **Access:** Customers have no access to the business dashboard. If they are logged in, they have access to a personal account section (`/store/account/*`) where they can view their order history, manage their profile, and see their wishlist.
